...
public class Movie {
	...
	public boolean equals(Object obj) {
		...
		return id.equals(movie.id) && title.equals(movie.title) && ageBracket.equals(movie.ageBracket) 
				&& duration.equals(movie.duration) && description.equals(movie.description);
